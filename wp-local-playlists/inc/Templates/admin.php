					...
					?>
						...
						<table class="wp-list-table widefat striped pages">
							...
							<tbody>
								<?php
									foreach ($cpts as $cpt):
										echo "<tr><td>{$cpt['mediaId']}</td><td>{$cpt['post_type']}</td><td>";
										echo '<form method="post" action="" class="inline-block">';
										echo "<input type='hidden' name='edit_post' value='{$cpt['mediaId']}'>";
										...
										echo "<input type='hidden' name='remove_post' value='{$cpt['mediaId']}'>";
